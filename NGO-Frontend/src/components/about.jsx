            ...
            <div className="about-block">
             ...
             <div className="about-key-points">
                ...
                <ul>
                  ...
                  <li><i className="icon-leaf"></i>Establishment and promotion of Khadi & Village Industries.</li>
                  <li><i className="icon-users"></i>Comprehensive development of artisans, especially women, and marginalized groups.</li>
                  <li><i className="icon-tools"></i>Production and wholesale/retail of Khadi products (cotton, silk, wool) and training .</li>
                  <li><i className="icon-link"></i>Training weavers in silk, cotton, and wool, and arranging modern equipment .</li>
                  <li><i className="icon-growth"></i>Providing employment through Khadi and Village Industries Board schemes .</li>
                </ul>
            </div>
